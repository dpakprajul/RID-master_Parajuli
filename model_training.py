...
from definitions import LABEL_CLASSES_SUPERSTRUCTURES, MODEL_NAME, MODEL_TYPE, DIR_SEGMENTATION_MODEL_DATA, \
    DIR_RESULTS_TRAINING, DATA_VERSION, LABEL_CLASSES_SUPERSTRUCTURES1
...
class Dataset:
    ...
    CLASSES = list(LABEL_CLASSES_SUPERSTRUCTURES1.values())
...
def model_training(MODEL_TYPE, BACKBONE, LABEL_CLASSES_SUPERSTRUCTURES1, DIR_SEGMENTATION_MODEL_DATA, DIR_MASKS,
