...
file_folder_path = "D:\\RID-master\\RID-master\\venv\\data\\augment_mask_output_roofline"
...
csv_image_coordinates_path = "D:\\RID-master\\RID-master\\center_points_google_earth.csv"
csv_image_coordinates_path
geotiff_source_directory = DIR_BASE + "\\images_roof_centered_geotiff"
...
ge_img_filepath = DIR_BASE + "\\data\\images_grid_geotiff_4800px" + "\\27.tif"
...
dir_images = "D:\\RID-master\\RID-master\\png_to_geotiff\\"
...
for image_coordinate in image_coordinates.iloc:
    ...
    lat = image_coordinate.lat
    lon = image_coordinate.lon
    ...
    if not gdf_Wartenberg_boundary.geometry.contains(Point(lon, lat)).any():
        ...
        if os.path.isfile(image_path):
            ...
            geotiff_path = save_geotiff_directory + "\\" + image_filename + ".png"
...
def open_geotiff(file_path):
 ...
 open_geotiff("D:\\RID-master\\RID-master\\images_roof_centered_geotiff\\2.tif")
