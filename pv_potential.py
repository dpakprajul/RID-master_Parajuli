...
def pv_potential_analysis():
    ...
    for i, mask in enumerate(prediction_masks):
        ...
        #gdf_predictions.to_csv("D:\\RID-master\\RID-master\\venv\\shapefile\\countries.csv")
    ...
    #gdf_superstructures_PR.to_file("D:\\RID-master\\RID-master\\venv\\shapefile\\countries.shp")
